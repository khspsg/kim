...
<form class="productinsert_form" name="productinput_form" 
			action="productInsert" method="post"
	...
	<div class="container">
		...
		<div class="row" style="margin-top:30px;color:#040044"">
			...
			<div class="col-md-6" style="text-align: center">
				<h1><i class="fa fa-product-hunt" aria-hidden="true"></i> 상품 등록</h1>
			</div>
			<div class="col-md-3"></div>
		</div>
		 		...
		 		<div>
		 			<div class="input-group">
						...
						<input name="code" id="code" class="form-control" type="text" size="20" 
							maxlength="13" placeholder="barcode(13자리)" data-parsley-type="number" 
							required="true" data-parsley-error-message="숫자만 입력하세요!"
							data-parsley-errors-container="div[id='codeError']"/>
						<span class="input-group-addon button btn btn-primary" id="codeconfirm" >중복검사</span>
		...
		<div class="row" style="margin-top:30px">  
		 	...
		 	<div class="col-md-6" style="text-align:center">
		 		<div>
		 			<button type="button" id="productsave" class="btn btn-success"><i class="fa fa-floppy-o" aria-hidden="true"></i> &nbsp&nbspSave&nbsp&nbsp</button>
