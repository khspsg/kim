...
<body onload="init()">
<form class="boardinput_form" name="boardinput_form" action="boardInsert" method="post"  enctype="multipart/form-data" role="form" data-parsley-validate="true">
	<div class="container">
		 	...
		 	<div class="col-md-6">
		 		<div>
		 			<div class="input-group">
						...
						<input name="b_email" id="b_email" value="${sessionemail}" readonly="readonly" class="form-control" type="email" size="20" />
					</div>
		 		</div>	 
		 	</div>
		</div>
		 	...
		 	<div class="col-md-6">
		 		<div>
		 			<div class="input-group">
						...
						<input name="b_name" id="name" class="form-control" value="${sessionname}" readonly="readonly"/>
					</div>
		 		</div>	 
		 	</div>
		</div>
