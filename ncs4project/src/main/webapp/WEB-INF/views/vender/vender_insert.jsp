...
<body>
<form class="venderinsert_form" name="venderinput_form" 
			action="venderInsert" method="post"
	...
	<div class="container">
		...
		<div class="row" style="margin-top:30px;color:#040044"">
			...
			<div class="col-md-6" style="text-align: center">
				<h1><i class="fa fa-registered" aria-hidden="true"></i> 거래처 등록</h1>
			</div>
			<div class="col-md-3"></div>
		</div>
		 		...
		 		<div>
		 			<div class="input-group">
						...
						<input name="busno1" id="busno1" class="form-control"
						 type="text" size="10"  maxlength="3" data-parsley-type="number" 
						 required="true" data-parsley-error-message="사업자번호1을 입력하세요!"
						 data-parsley-errors-container="div[id='busnoErrorError']"/>
						<span class="input-group-addon"> - </span>
						<input name="busno2" id="busno2" class="form-control"
						 type="text" size="6"  maxlength="2" data-parsley-type="number" 
						 required="true" data-parsley-error-message="사업자번호2을 입력하세요!"
						 data-parsley-errors-container="div[id='busnoErrorError']"/>
						<span class="input-group-addon"> - </span>
						<input name="busno3" id="busno3" class="form-control"
						 type="text" size="16"  maxlength="5" data-parsley-type="number" 
